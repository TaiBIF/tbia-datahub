...
class Taxon(Base):
    ...
    formatted_kingdom: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_subkingdom: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_infrakingdom: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_superphylum: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_phylum: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_subphylum: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_infraphylum: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_superclass: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_class: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_subclass: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_infraclass: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_superorder: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_order: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_family: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_subfamily: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_superfamily: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_suborder: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_infraorder: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_tribe: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_subtribe: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_realm: Mapped[Optional[str]] = mapped_column(String(10000))
    formatted_unranked: Mapped[Optional[str]] = mapped_column(String(10000))
