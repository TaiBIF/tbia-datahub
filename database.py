...
class Records(Base):
    ...
    sourceKingdom: Mapped[Optional[str]] = mapped_column(String(10000))
    # # 日期改存年月日 (pending) 先拿掉
...
class Taxon(Base):
    ...
    bioGroup: Mapped[Optional[str]] = mapped_column(String(10000))
    ...
    formatted_genus: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subgenus: Mapped[Optional[str]] = mapped_column(Text)
    formatted_section: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subsection: Mapped[Optional[str]] = mapped_column(Text)
    formatted_species: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subspecies: Mapped[Optional[str]] = mapped_column(Text)
    formatted_nothosubspecies: Mapped[Optional[str]] = mapped_column(Text)
    formatted_variety: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subvariety: Mapped[Optional[str]] = mapped_column(Text)
    formatted_nothovariety: Mapped[Optional[str]] = mapped_column(Text)
    formatted_form: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subform: Mapped[Optional[str]] = mapped_column(Text)
    formatted_race: Mapped[Optional[str]] = mapped_column(Text)
    formatted_morph: Mapped[Optional[str]] = mapped_column(Text)
    formatted_aberration: Mapped[Optional[str]] = mapped_column(Text)
    formatted_name: Mapped[Optional[str]] = mapped_column(Text)
    formatted_synonyms: Mapped[Optional[str]] = mapped_column(Text)
    formatted_misapplied: Mapped[Optional[str]] = mapped_column(Text)
    ...
    misapplied: Mapped[Optional[str]] = mapped_column(Text)
    ...
    taxon_name_id: Mapped[Optional[str]] = mapped_column(String(10000))
    ...
    is_in_taiwan: Mapped[Optional[bool]]
    formatted_kingdom: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subkingdom: Mapped[Optional[str]] = mapped_column(Text)
    formatted_infrakingdom: Mapped[Optional[str]] = mapped_column(Text)
    formatted_superphylum: Mapped[Optional[str]] = mapped_column(Text)
    formatted_phylum: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subphylum: Mapped[Optional[str]] = mapped_column(Text)
    formatted_infraphylum: Mapped[Optional[str]] = mapped_column(Text)
    formatted_superclass: Mapped[Optional[str]] = mapped_column(Text)
    formatted_class: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subclass: Mapped[Optional[str]] = mapped_column(Text)
    formatted_infraclass: Mapped[Optional[str]] = mapped_column(Text)
    formatted_superorder: Mapped[Optional[str]] = mapped_column(Text)
    formatted_order: Mapped[Optional[str]] = mapped_column(Text)
    formatted_family: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subfamily: Mapped[Optional[str]] = mapped_column(Text)
    formatted_superfamily: Mapped[Optional[str]] = mapped_column(Text)
    formatted_suborder: Mapped[Optional[str]] = mapped_column(Text)
    formatted_infraorder: Mapped[Optional[str]] = mapped_column(Text)
    formatted_tribe: Mapped[Optional[str]] = mapped_column(Text)
    formatted_subtribe: Mapped[Optional[str]] = mapped_column(Text)
    formatted_realm: Mapped[Optional[str]] = mapped_column(Text)
    formatted_unranked: Mapped[Optional[str]] = mapped_column(Text)
    unranked: Mapped[Optional[str]] = mapped_column(String(10000))
    unranked_c: Mapped[Optional[str]] = mapped_column(String(10000))
    realm: Mapped[Optional[str]] = mapped_column(String(10000))
    realm_c: Mapped[Optional[str]] = mapped_column(String(10000))
    kingdom_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subkingdom_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    infrakingdom_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    superphylum_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    phylum_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    class_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    order_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    family_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subphylum_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    infraphylum_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    superclass_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subclass_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    infraclass_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    superorder_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subfamily_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    superfamily_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    suborder_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    infraorder_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    tribe_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subtribe_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    genus_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    species_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    section_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subgenus_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subspecies_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    variety_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    subsection_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    realm_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
    unranked_taxonID: Mapped[Optional[str]] = mapped_column(String(10000))
